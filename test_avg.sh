...
dataset=$2
num_checkpoints=$3
python3 LNMT-CA/scripts/average_checkpoints.py --inputs checkpoints/$modelfile --num-epoch-checkpoints $num_checkpoints --output checkpoints/$modelfile/average_epoch.pt 
